...
nass_price_received <- read_parquet(here(
  "binaries",
  "nass_quickstats_price_received.parquet"
))
nass_production <- read_parquet(here(
  "binaries",
  "nass_quickstats_production.parquet"
))
nass_acreage <- read_parquet(here(
  "binaries",
  "nass_quickstats_acreage.parquet"
))
nass_yield <- read_parquet(here("binaries", "nass_quickstats_yield.parquet"))
nass_census_acreage <- read_parquet(here(
  "binaries",
  "nass_quickstats_census_acreage.parquet"
))
