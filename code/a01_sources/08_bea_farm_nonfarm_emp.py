# Purpose: Extract county farm employment and related BEA source measures.
# Inputs: BEA CAEMP25N and CAINC45 archives in data/raw/bea.
# Outputs: trimmed BEA tables and bea_farm_nonfarm_emp.parquet.
