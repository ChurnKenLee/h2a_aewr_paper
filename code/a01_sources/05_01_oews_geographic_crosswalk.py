# Purpose: Harmonize historical OEWS reporting areas to project counties.
# Inputs: OEWS area definitions and the project county adjacency crosswalk.
# Outputs: data/intermediate/oews_area_definitions.parquet and diagnostics.
