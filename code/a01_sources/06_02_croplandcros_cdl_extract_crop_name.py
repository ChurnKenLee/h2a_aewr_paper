# Purpose: Attach CDL crop labels and convert county pixel counts to crop acres.
# Inputs: county CDL pixel counts and CroplandCROS crop metadata.
# Outputs: data/intermediate/croplandcros_county_crop_acres.parquet
