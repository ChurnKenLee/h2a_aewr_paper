# Purpose: Build annual county climate predictors from NOAA gridded data.
# Inputs: cached NOAA NClimGrid files and project county geometry.
# Outputs: county_h2a_prediction_climate_basis_annual.parquet.
