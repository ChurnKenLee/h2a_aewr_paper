...
| `08_bea_farm_nonfarm_emp.py` | Extract archived county employment and farm-income tables and map BEA combined areas to canonical counties | Trimmed BEA files and farm employment |
