# Purpose: Combine annual QCEW archives into the project-wide annual source table.
# Inputs: annual QCEW single-file ZIP archives in data/raw/qcew.
# Outputs: data/intermediate/qcew.parquet
...
def _(binary_path, pl, qcew_cols_list, qcew_dtype_dict, qcew_path, zipfile):
    ...
    for t in range(2000, 2025):
        ...
        annual_frames.append(_df)

    qcew_df = pl.concat(annual_frames, how="vertical_relaxed")
