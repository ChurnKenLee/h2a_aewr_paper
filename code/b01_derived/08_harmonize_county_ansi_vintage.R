# Purpose: Harmonize county identifiers in derived artifacts to the 2010 vintage.
# Inputs: county-bearing artifacts produced by the A and earlier B scripts.
# Outputs: updated versions of those artifacts at their existing intermediate paths.
