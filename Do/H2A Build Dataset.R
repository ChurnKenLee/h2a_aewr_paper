...
acs_immigrant_imputed <- read_parquet(paste0(
  folder_data,
  "acs_immigrant_cleaned.parquet"
))
acs_qcew_data <- read_parquet(paste0(folder_data, "acs_qcew_data.parquet"))
...
bea_caemp25n_data <- read_parquet(paste0(
  folder_data,
  "bea_caemp25n_data.parquet"
))
bea_cainc45_data <- read_parquet(paste0(
  folder_data,
  "bea_cainc45_data.parquet"
))
border_df <- read_parquet(paste0(folder_data, "border_df.parquet"))
fips_codes <- read.csv(
...
census_pop_ests <- read_parquet(paste0(folder_data, "census_pop_ests.parquet"))
...
border_df %>% write_parquet(paste0(folder_data, "border_df_analysis.parquet"))
...
border_df <- read_parquet(paste0(folder_data, "border_df_year.parquet"))
fips_codes <- read.csv(
  file = paste0(folder_data, "fips_codes.csv"),
  stringsAsFactors = F
)
...
census_of_agriculture_cropland_base <- read_parquet(
  file = paste0(folder_data, "census_ag_cropland_2007_year.parquet")
)
...
border_df %>%
  write_parquet(paste0(folder_data, "border_df_analysis_year.parquet"))
