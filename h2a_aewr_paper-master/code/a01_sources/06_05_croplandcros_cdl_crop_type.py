# Purpose: Classify CDL crop codes into the crop groups used by the analysis.
# Inputs: CDL metadata and data/intermediate/cdl_nass_xwalk.parquet.
# Outputs: data/intermediate/cdl_crop_type.parquet
