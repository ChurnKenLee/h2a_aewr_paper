# Purpose: Convert RMA Summary of Business archives to coverage and type-practice-unit tables.
# Inputs: RMA Summary of Business source archives.
# Outputs: data/intermediate/rma_sob_cov.parquet and rma_sob_tpu.parquet.
